...
public class MyCV1 extends JApplet
{
	JFrame f1;
	JPanel p1;
	JButton b1;
	...
	public void init()
	{
		...
		Font mf1=new Font("Monotype Corosiva",Font.BOLD|Font.ITALIC,34);
		p1=new JPanel();
		l1=new JLabel();
		...
		i1=new ImageIcon("deb2.jpg");
		l4=new JLabel("   ");
		l4.setIcon(i1);
		l4.setForeground(Color.blue);
		l4.setBounds(625,70,130,150);
		//l4.setIcon(i1);
		p1.add(l4);
		...
		rdS1.setBackground(Color.pink);
		rdS2.setBackground(Color.pink);
		bg1.add(rdS1);
		bg1.add(rdS2);
		p1.add(lSex);
		p1.add(rdS1);
		...
		rdM1.setBackground(Color.pink);
		rdM2.setBackground(Color.pink);
		bg2.add(rdM1);
		bg2.add(rdM2);
		p1.add(lMar);
		p1.add(rdM1);
